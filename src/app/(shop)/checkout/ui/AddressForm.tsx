...
interface Props {
    ...
    userStoreAddress?: Partial<Address> | null | undefined;
}
export const AdressForm = ({ paises, userStoreAddress = {} }: Props) => {
        ...
        >
            ...
            <div className="flex flex-col mb-2">
                ...
                >
                    ...
                    {paises.map((r, index) => {
                        return (
                            <option key={`${r}-${index}`} value={r.nombre}>
                                {r.nombre}
                            </option>
                        );
                    })}
